    ...
    return GridView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        if (isConfirm) {
          bg     = AppColors.cobalt;
          fg     = Colors.white;
          shadow = AppColors.cobaltDark;
        } else if (isDelete) {
          bg     = isDark ? const Color(0xFF3A2A2A) : const Color(0xFFFFE4E4);
          fg     = AppColors.heartRed;
          shadow = isDark ? const Color(0xFF2A1A1A) : AppColors.heartDanger.withOpacity(0.4);
        } else {
          bg     = isDark ? AppColors.darkCard : AppColors.keyWhite;
          fg     = isDark ? Colors.white : AppColors.cobalt;
          shadow = isDark ? AppColors.darkBg : AppColors.cobaltShadow18;
        }
